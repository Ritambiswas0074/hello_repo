...
export default function Stepper({
  ...
  }, [totalSteps, autoAdvance, autoAdvanceInterval, onStepChange, onFinalStepCompleted]);
    ...
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: 'rgba(132, 0, 255, 1)', color: '#ffffff' },
          complete: { scale: 1, backgroundColor: 'rgba(132, 0, 255, 1)', color: '#ffffff' }
        }}
...
function StepConnector({ isComplete }) {
  const lineVariants = {
    ...
    complete: { width: '100%', backgroundColor: 'rgba(132, 0, 255, 1)' }
  };
